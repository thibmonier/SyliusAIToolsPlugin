...
export COMPOSE_PROJECT_NAME=sylius_a_i_tools
PLUGIN_NAME=sylius-a-i-tools
COMPOSE=docker compose
YARN=yarn
DOCTRINE_MIGRATIONS_NAMESPACE=ACSEO\SyliusAITools\Migrations
...
setup_application:
	...
	$(MAKE) apply_dist
	(cd ${APP_DIR} && ${COMPOSER} require --no-progress acseo/sylius-ai-tools="*@dev")
